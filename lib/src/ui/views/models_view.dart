...
class _ModelsViewState extends State<ModelsView> {
  ...
  Widget build(BuildContext context) {
    ...
    final loading = modelProvider.loading;
                  ...
                  : GenericTable(
                                ...
                                try {
                                  ...
                                  if (deleted) {
                                    NotificationService.showSnackbarSuccess(
                                        'Model eliminado con exito.');
                                  } else {
                                    NotificationService.showSnackbarSuccess(
                                        'No se pudo eliminar el Model.');
                                  }
                                } on ErrorAPI catch (e) {
                      ...
                      columns: [
                        ...
                        DTColumn(
                          ...
                          dataAttribute: 'mark',
                          widget: (item) =>
                              Text(item['mark_display']['description']),
                        ),
                        DTColumn(
                            header: "Descripción",
                      ...
                      onSearch: (value) {
                        modelProvider.search(value);
                      },
                      searchInitialValue: modelProvider.searchValue,
                    ),
            ],
          ),
        ),
