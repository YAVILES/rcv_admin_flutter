            ...
            children: [
              ...
              Wrap(
                children: [
                    ...
                    child: Stack(
                      children: [
                        SizedBox(
                          width: 200,
                          child: Hero(
                            tag: sectionProvider.section?.id ?? 'newSection',
                            child: (image?.bytes != null)
                                ? Image.memory(
                                    Uint8List.fromList(image!.bytes!),
                                    fit: BoxFit.contain)
                                : sectionProvider.section?.imageDisplay != null
                                    ? Image.network(
                  ...
                  if (sectionProvider.type?.value == SectionService.box) ...[
                    Padding(
                      padding: const EdgeInsets.all(15.0),
                      child: Stack(
                        children: [
                          SizedBox(
                            ...
                            child: (shape?.bytes != null)
                                ? Image.memory(
                                    ...
                                    fit: BoxFit.contain)
                                : sectionProvider.section?.shapeDisplay != null
                                    ? Image.network(
                            ...
                            child: Container(
                              ...
                              child: FloatingActionButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (result != null) {
                                    setState(() => shape = result.files.first);
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: (icon?.bytes != null)
                                ? Image.memory(Uint8List.fromList(icon!.bytes!),
                                    fit: BoxFit.contain)
                                : sectionProvider.section?.iconDisplay != null
                                    ? Image.network(
                            ...
                            child: Container(
                              ...
                              child: FloatingActionButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (result != null) {
                                    setState(() => icon = result.files.first);
              ...
              TextFormField(
                ...
                onChanged: (value) => sectionProvider.section!.title = value,
              ...
              TextFormField(
                ...
                onChanged: (value) => sectionProvider.section!.subtitle = value,
                decoration: CustomInputs.buildInputDecoration(
              ...
              TextFormField(
                ...
                onChanged: (value) => sectionProvider.section!.content = value,
              ...
              TextFormField(
                ...
                onChanged: (value) => sectionProvider.section!.url = value,
                validator: (value) {
                  if (value == null || value.isEmpty) {
              ...
              CustomCheckBox(
                ...
                onChanged: (value) => sectionProvider.section!.isActive = value,
              ),
              Container(
                ...
                child: CustomButtonPrimary(
                  onPressed: () async {
                    try {
                      final bool create = sectionProvider.section!.id == null;
